...
const AboutUs: React.FC = () => {
  return (
    <div className="relative group mb-16">
      <div className="bg-card text-card-foreground p-8 md:p-12 border rounded-3xl shadow-sm">
        <div className="flex items-center space-x-4 mb-8">
        ...
        <div className="space-y-6 text-muted-foreground leading-relaxed">
          ...
          <div className="grid md:grid-cols-2 gap-6 mt-8">
            <div className="bg-muted/50 rounded-xl p-6 border transition-all duration-300 hover:shadow-md">
          ...
          <div className="bg-primary/5 rounded-xl p-6 border border-primary/20 mt-8">
            <h3 className="text-xl font-bold text-foreground mb-3 flex items-center">
              <div className="w-8 h-8 bg-secondary rounded-lg flex items-center justify-center mr-3 text-lg">
                <span className="text-lg">🔒</span>
              </div>
              Privacy & Meaningful Interactions
            </h3>
          ...
          <div className="text-center rounded-xl p-6 border shadow-sm mt-8 border-t-primary/20">
            ...
            <p className="text-primary text-xl font-bold mt-2 flex items-center justify-center gap-2">
              It&apos;s more than just a chat - it&apos;s an experience.
      ...
      <div className="bg-card text-card-foreground p-8 md:p-12 border rounded-3xl shadow-sm">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-4 mb-8">
          {guidelines.map((guideline, index) => (
            <div
              key={index}
              className="bg-muted/40 rounded-xl p-4 border transition-all duration-300 hover:shadow-md hover:bg-muted/60"
            >
              <div className="flex items-start space-x-3">
        ...
        <div className="bg-destructive/10 rounded-xl p-6 border border-destructive/20">
          ...
          <p className="text-destructive/90 text-sm font-medium leading-relaxed">
            Improper use of the service, including sexual statements, offensive,
            or violent behavior, is
